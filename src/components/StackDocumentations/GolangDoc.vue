<template>
    ...
    <div class="mt-10">
        ...
        <div class="my-8">
            <CodeSnippet :code="backendSnippet" :copy-code="backendSnippetCopy" filename="main.go" />
        </div>
    </div>
    <div class="mt-10 mb-20">
        <p class="mt-6 text-xl leading-8">For a full example take a look at <a target="_blank" class="text-orange-600 hover:text-orange-900" href="https://docs.ressonance.com/using-ressonance/golang/public-channels">Ressonance documentation</a>.</p>
    </div>
</template>
...
func main() {
    ...
    err := client.Trigger("public-channel", "new-release", map[string]string{
        "release": "hello world",
    })
    if err != nil {
        panic(err)

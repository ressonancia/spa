<template>
    ...
    <div class="mt-10 mb-20">
        <p class="mt-6 text-xl leading-8">For a full example take a look at <a target="_blank" class="text-orange-600 hover:text-orange-900" href="https://docs.ressonance.com/using-ressonance/nodejs-raw/public-channels">Ressonance documentation</a>.</p>
    </div>
</template>
...
await pusher.trigger('public-channel', 'new-release', {
  release: 'hello world'
});
`
</script>

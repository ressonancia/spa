<template>
    ...
    <div class="mt-10">
        ...
        <div class="my-8">
            <CodeSnippet :code="backendSnippet" :copy-code="backendSnippetCopy" filename="send-public-event.php" />
        </div>
    </div>
    <div class="mt-10 mb-20">
        <p class="mt-6 text-xl leading-8">For a full example take a look at <a target="_blank" class="text-orange-600 hover:text-orange-900" href="https://docs.ressonance.com/using-ressonance/php/public-channels">Ressonance documentation</a>.</p>
    </div>
</template>
